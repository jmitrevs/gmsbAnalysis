...
#topSequence += TriggerFilter( "D2PDTriggerFilterGMSBM",
...
fileName   = D2PDFlags.OutputDirectoryName() + "D2AOD_GMSBee.pool.root"
SimpleGMSBStream = MSMgr.NewPoolStream( streamName, fileName )

# Only events that pass the filters listed below are written out
# AcceptAlgs  = logical OR of filters
# RequireAlgs = logical AND of filters
SimpleGMSBStream.AcceptAlgs( ["DiElectronSelector"] )
...
#SimpleGMSBStream.AddItem( ['INav4MomLinkContainer#SelectedPhotonLinkCollection'] )
