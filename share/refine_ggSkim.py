...
topSequence += D2PDPhotonSelector( "DiPhotonSelector",
                                   OutputLevel                      = INFO,
                                   inputCollection                  = 'PhotonAODCollection',
                                   outputLinkCollection             = 'SelectedDiPhotonLinkCollection',
                                   minNumberPassed                  = 2,
...
topSequence += D2PDPhotonSelector( "HighPtPhotonSelector",
                                   OutputLevel                      = INFO,
                                   inputCollection                  = 'SelectedDiPhotonLinkCollection',
...
fileName   = D2PDFlags.OutputDirectoryName() + "D2AOD_GMSBgg2.pool.root"
