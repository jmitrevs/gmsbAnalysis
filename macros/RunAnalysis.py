...
def RunAnalysis(lepton):
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.WlepnuFile_Np0.Get(ttreeName), 
                                        ...
                                        removeOverlap, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.WgammaFile_Np0.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.Wgamma_Np0_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.WgammaFile_Np1.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.Wgamma_Np1_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.WgammaFile_Np2.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.Wgamma_Np2_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.WgammaFile_Np3.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.Wgamma_Np3_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.WgammaFile_Np4.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.Wgamma_Np4_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.WgammaFile_Np5.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.Wgamma_Np5_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    print
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.ttbarFile.Get(ttreeName), 
                                        ...
                                        removeOverlapTtbar,
                                        applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.ttbargammaFile.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.ttbargamma_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.st_tchan_lepnuFile.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.st_tchan_lepnu_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.st_tchan_taunuFile.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.st_tchan_taunu_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.st_WtFile.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.st_Wt_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.WWFile.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.WW_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.WZFile.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.WZ_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.ZZFile.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.ZZ_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.ZleplepgammaFile.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.Zleplepgamma_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.ZtautaugammaFile.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.Ztautaugamma_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    if lepton == ELECTRON:
        ...
        LepPhotonAnalysis.LepPhotonAnalysis(DataManager.Zee_altFile.Get(ttreeName), 
                                            ...
                                            removeOverlap, applySF=LepPhotonAnalysis.NONE, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
        print
    print "Ztautau_Np0:"
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.gammaFile_Np1.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.gamma_Np1_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.gammaFile_Np2.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.gamma_Np2_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.gammaFile_Np3.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.gamma_Np3_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.gammaFile_Np4.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.gamma_Np4_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.gammaFile_Np5.Get(ttreeName), 
                                        ...
                                        lepton,
                                        DataManager.gamma_Np5_scale, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    print
    if lepton == ELECTRON:
        print "diphotons:"
        LepPhotonAnalysis.LepPhotonAnalysis(DataManager.diphotonsFile.Get(ttreeName), 
                                            ...
                                            lepton,
                                            DataManager.diphotons_scale, applySF=LepPhotonAnalysis.NONE, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
        print
    ...
    LepPhotonAnalysis.LepPhotonAnalysis(DataManager.winoFile.Get(ttreeName), 
                                        ...
                                        onlyStrong=onlyStrong, applySF=LepPhotonAnalysis.NOMINAL, applyTrigWeight=LepPhotonAnalysis.NOMINAL)
    print
