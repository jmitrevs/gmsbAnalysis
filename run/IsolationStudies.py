...
InputList = glob('/data3/jmitrevs/mcskims/mc10*PythiaZee_1Lepton*/*pool.root*')
#InputList = glob('/data3/jmitrevs/mcskims/user.jmitrevs.20101123.98.mc09_7TeV.106046.PythiaZee_no_filter.merge.AOD.e468_s831_s832_r1305_r1306*/*pool.root*')
#InputList = glob('/data3/jmitrevs/mcskims/user.jmitrevs.20101123.99.mc09_7TeV.106046.PythiaZee_no_filter.merge.AOD.*_r1429*/*pool.root*')
#InputList = glob('/data3/jmitrevs/AtlasProduction-16.0.2.5/run/*pool.root*')
#InputList = glob('/data3/jmitrevs/mc09_7TeV.106046.PythiaZee_no_filter.merge.AOD.e468_s831_s832_r1305_r1306*/*pool.root*')
...
rec.UserAlgs.set_Value_and_Lock("IsolationStudies_simple.py")
