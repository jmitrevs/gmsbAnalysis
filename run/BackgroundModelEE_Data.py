...
InputList = glob('/data3/jmitrevs/dataskims/ee_combined/ee_merge/user.jmitrevs.*periodI*/*.pool.root*')
...
rec.UserAlgs.set_Value_and_Lock("BackgroundModelEE_Data_simple.py")
