...
InputList = glob('/data3/jmitrevs/dataskims/ee_uncombined/ee_merged/user.jmitrevs.*/*.pool.root*')
...
rec.UserAlgs.set_Value_and_Lock("IsolationStudies_Data_simple.py")
