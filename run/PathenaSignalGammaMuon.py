...
for i,inDS in enumerate(inDS_full):
    ...
    command = "pathena --mergeOutput --nGBPerJob=MAX --inDS %s/ --outDS user.jmitrevs.GM_120520.%s SignalGammaMuon.py " % (inDS, outName)
    
    # if i == 0:
    #     command += " --outTarBall=/data3/jmitrevs/submission_gammamu_120520.tar"
    # else:
    #     command += " --inTarBall=/data3/jmitrevs/submission_gammamu_120520.tar"
...
for i,inDS in enumerate(inDS_Wjets):
    ...
    command = "pathena --mergeOutput --nGBPerJob=MAX --inDS %s/ --outDS user.jmitrevs.GM_120520.%s SignalGammaMuon_Wjets.py " % (inDS, inDS)
    
    # if i == 0:
    #     command += " --outTarBall=/data3/jmitrevs/submission_gammamu_120520Wjets.tar"
    # else:
    #     command += " --inTarBall=/data3/jmitrevs/submission_gammamu_120520Wjets.tar"
...
for i,inDS in enumerate(inDS_Zjets):
    ...
    command = "pathena --mergeOutput --nGBPerJob=MAX --inDS %s/ --outDS user.jmitrevs.GM_120520.%s SignalGammaMuon_Zjets.py " % (inDS, inDS)
...
for i,inDS in enumerate(inDS_Zjets):
    ...
    command = "pathena --mergeOutput --nGBPerJob=MAX --inDS %s/ --outDS user.jmitrevs.GM_120520.%s SignalGammaMuon_Ztaujets.py " % (inDS, inDS)
...
for i,inDS in enumerate(inDS_ttbar):
    ...
    command = "pathena --mergeOutput --nGBPerJob=MAX --inDS %s/ --outDS user.jmitrevs.GM_120520.%s SignalGammaMuon_ttbar.py " % (inDS, inDS)
