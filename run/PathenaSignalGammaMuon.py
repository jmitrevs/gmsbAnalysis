...
for i,inDS in enumerate(inDS_test):
    ...
    command = "pathena --mergeOutput --nGBPerJob=MAX --inDS %s/ --outDS user.jmitrevs.GM_130311.%s newSignalGammaMuon.py " % (inDS, outName)
    ...
    # if i == 0:
    #     command += " --outTarBall=/data3/jmitrevs/submission_gammamu_120901.tar"
    # else:
...
for i,inDS in enumerate(inDS_ttbar):
    ...
    command = "pathena --mergeOutput --nGBPerJob=MAX --inDS %s/ --outDS user.jmitrevs.GM_120902.%s SignalGammaMuon_ttbar.py " % (inDS, inDS)
    #command = "pathena --mergeOutput --nGBPerJob=MAX --inDS %s/ --outDS user.jmitrevs.GMiso_120901.%s SignalGammaMuon_ttbar_test.py " % (inDS, inDS)
...
for i,inDS in enumerate(inDS_Wjets):
    ...
    # if i == 0:
    #     command += " --outTarBall=/data3/jmitrevs/submission_gammamu_120821.tar"
    # else:
    #     command += " --inTarBall=/data3/jmitrevs/submission_gammamu_120821.tar"
...
for i,inDS in enumerate(inDS_Zjets):
    ...
    command = "pathena --mergeOutput --nGBPerJob=MAX --inDS %s/ --outDS user.jmitrevs.GM_120902.%s SignalGammaMuon_Zjets.py " % (inDS, inDS)
...
for i,inDS in enumerate(inDS_Zjets):
    ...
    command = "pathena --mergeOutput --nGBPerJob=MAX --inDS %s/ --outDS user.jmitrevs.GM_120902.%s SignalGammaMuon_Ztaujets.py " % (inDS, inDS)
