...
MCTruthClassifier.MCTruthClassifierBase.MCTruthClassifier.McEventCollection = "TruthEvent"
...
gmsbSelectionTool.MCTruthClassifier = MCTruthClassifier.MCTruthClassifierBase.MCTruthClassifier
gmsbSelectionTool.DoTruth = False
...
gmsbSelectionTool.ElectronID = egammaPID.ElectronIDMedium
...
testAlg = SignalGammaLepton(name = "SignalGammaLepton",
                            isMC = True,
                            McEventContainerName = "TruthEvent",
