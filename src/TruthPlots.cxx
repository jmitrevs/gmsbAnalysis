...
StatusCode TruthPlots::initialize(){
  ...
  m_histograms["top_eta1"] = new TH1F("top_eta1","Psuedorapidity of the leading top;#eta", 100, -3,3);
  m_histograms["top_pt1"] = new TH1F("top_pt1","Transverse momentum of the leading top;p_{T} [GeV]", 500, 0, 500);
  m_histograms["top_m1"] = new TH1F("top_m1","Mass of the leading top;p_{T} [GeV]", 500, 0, 500);
  m_histograms["top_eta2"] = new TH1F("top_eta2","Psuedorapidity of the second top;#eta", 100, -3,3);
  m_histograms["top_pt2"] = new TH1F("top_pt2","Transverse momentum of the second top;p_{T} [GeV]", 500, 0, 500);
  m_histograms["top_m2"] = new TH1F("top_m1","Mass of the second top;p_{T} [GeV]", 500, 0, 500);

  m_histograms["W_eta1"] = new TH1F("W_eta1","Psuedorapidity of the leading W;#eta", 100, -3,3);
  m_histograms["W_pt1"] = new TH1F("W_pt1","Transverse momentum of the leading W;p_{T} [GeV]", 500, 0, 500);
  m_histograms["W_eta2"] = new TH1F("W_eta2","Psuedorapidity of the second W;#eta", 100, -3,3);
  m_histograms["W_pt2"] = new TH1F("W_pt2","Transverse momentum of the second W;p_{T} [GeV]", 500, 0, 500);

  m_histograms["bFromTop_eta1"] = new TH1F("bFromTop_eta1","Psuedorapidity of the leading bFromTop;#eta", 100, -3,3);
  m_histograms["bFromTop_pt1"] = new TH1F("bFromTop_pt1","Transverse momentum of the leading bFromTop;p_{T} [GeV]", 500, 0, 500);
  m_histograms["bFromTop_eta2"] = new TH1F("bFromTop_eta2","Psuedorapidity of the second bFromTop;#eta", 100, -3,3);
  m_histograms["bFromTop_pt2"] = new TH1F("bFromTop_pt2","Transverse momentum of the second bFromTop;p_{T} [GeV]", 500, 0, 500);

  m_histograms["otherB_eta1"] = new TH1F("otherB_eta1","Psuedorapidity of the leading otherB;#eta", 100, -3,3);
  m_histograms["otherB_pt1"] = new TH1F("otherB_pt1","Transverse momentum of the leading otherB;p_{T} [GeV]", 500, 0, 500);
  m_histograms["otherB_eta2"] = new TH1F("otherB_eta2","Psuedorapidity of the second otherB;#eta", 100, -3,3);
  m_histograms["otherB_pt2"] = new TH1F("otherB_pt2","Transverse momentum of the second otherB;p_{T} [GeV]", 500, 0, 500);

  m_histograms["lightQ_eta1"] = new TH1F("lightQ_eta1","Psuedorapidity of the leading lightQ;#eta", 100, -3,3);
  m_histograms["lightQ_pt1"] = new TH1F("lightQ_pt1","Transverse momentum of the leading lightQ;p_{T} [GeV]", 500, 0, 500);
  m_histograms["lightQ_eta2"] = new TH1F("lightQ_eta2","Psuedorapidity of the second lightQ;#eta", 100, -3,3);
  m_histograms["lightQ_pt2"] = new TH1F("lightQ_pt2","Transverse momentum of the second lightQ;p_{T} [GeV]", 500, 0, 500);
...
StatusCode TruthPlots::execute() 
{
  ...
  if (tops.size() > 0) {
    ...
    m_histograms["top_m1"]->Fill(top->generated_mass(), weight);
    const HepMC::FourVector& p = top->momentum();
    m_histograms["top_pt1"]->Fill(p.perp(), weight);
    m_histograms["top_eta1"]->Fill(p.eta(), weight);
  }
  if (tops.size() > 1) {
    const HepMC::GenParticle *top = tops[1];
    m_histograms["top_m2"]->Fill(top->generated_mass(), weight);
    const HepMC::FourVector& p = top->momentum();
    m_histograms["top_pt2"]->Fill(p.perp(), weight);
